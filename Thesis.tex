...
\begin{document}
\include{config/colors} % several predefined colors - including the HSU corporate Design.

\pagenumbering{roman} % sonst gibt es 2 mal Seiten 1 und 2 (arabisch)
% so werden Probleme bei hyperlinks vermieden

\include{precontent/title_en}
...
\cleardoublepage
\include{precontent/abstract}

% \cleardoublepage
% \include{precontent/thanks}

\cleardoublepage
\include{precontent/statement}

% \cleardoublepage
% \include{precontent/foreword}

\cleardoublepage
\input{config/fanc_h_2.tex} % set fancy headings
\include{precontent/toc}
\cleardoublepage
...
% \include{precontent/symbol_list}

\cleardoublepage
\phantomsection
\addcontentsline{toc}{chapter}{\protect\numberline{List of Abbreviations}}
\include{postcontent/abbreviation}
...
\cleardoublepage
\include{content/01_00_introduction}

\cleardoublepage
\include{content/02_00_prerequisites}

\cleardoublepage
\include{content/03_00_implementation}

\cleardoublepage
\include{content/04_00_evaluation}

\cleardoublepage
\include{content/05_00_conclusion}

\cleardoublepage
\include{content/00_daily}
...
\begin{appendix}
	...
	\include{postcontent/appendix1}

	% \cleardoublepage
	% \include{postcontent/appendix2}
...
\include{postcontent/softwareeng}

\cleardoublepage
\include{postcontent/bibeng}
