...
\newcommand{\unsure}[2][1=]{\todo[linecolor=red,backgroundcolor=red!20,bordercolor=red,#1]{#2}}
\newcommand{\change}[2][1=]{\todo[linecolor=blue,backgroundcolor=blue!25,bordercolor=blue,#1]{#2}}
\newcommand{\info}[2][1=]{\todo[linecolor=green!75!black,backgroundcolor=green!75!black!30,bordercolor=green!75!black,#1]{#2}}
\newcommand{\thiswillnotshow}[2][1=]{\todo[disable,#1]{#2}}

\newcommand{\code}[4]{\lstinputlisting[float=htp, language=Python, basicstyle=\ttfamily\scriptsize,
        caption={#4},
        label=lst:bsp,
        numbers=left,
