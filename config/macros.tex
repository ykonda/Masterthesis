...
% align macros breaks the normal way with newcommand
% https://tex.stackexchange.com/questions/210315/problem-with-newcommand-nal-endalign
\def\bal#1\eal{\begin{align}#1\end{align}}

% macros for todo
\newcommand{\missing}[2][1=]{\todo[linecolor=blue!20!red,backgroundcolor=blue!20!red!40,bordercolor=blue!20!red,#1]{#2}}
\newcommand{\info}[2][1=]{\todo[linecolor=yellow,backgroundcolor=yellow!60!,bordercolor=yellow,#1]{#2}}
\newcommand{\change}[2][1=]{\todo[linecolor=blue,backgroundcolor=blue!25,bordercolor=blue,#1]{#2}}
\newcommand{\unsure}[2][1=]{\todo[linecolor=green!75!black,backgroundcolor=green!75!black!30,bordercolor=green!75!black,#1]{#2}}
\newcommand{\thiswillnotshow}[2][1=]{\todo[disable,#1]{#2}}

% pseudo code
\newcommand{\code}[5]{\lstinputlisting[float=htp, language=python, basicstyle=\ttfamily\scriptsize,
        caption={#4},
        label=lst:#5,
        numbers=left,
        firstline=#2, lastline=#3,
        stepnumber=1]{sourcecodes/#1.py}}
