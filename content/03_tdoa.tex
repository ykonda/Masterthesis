...
distinct direction.
\Cref{tab:03_maxFrequncies} lists the most feasible reference frequencies (Max. Frequency)
...
\hline
\etab
\et{Most feasible frequencies for unambiguous phase difference detection}{03_maxFrequncies}
% -------------------------------------------------------------
