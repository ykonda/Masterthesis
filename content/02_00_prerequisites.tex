...
\Cref{sec:02_tdoa} introduces the different methods to observe the time delay
...
\Cref{sec:02_filter} describes the formulas for Bayesian Updating in two-dimensional space.
