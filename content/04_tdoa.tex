...
\hline
0 & 1 & -8.25\si{\degree} & -144.9\si{\degree} & -35.1\si{\degree} \\
\hline
1 & 3 & -4.59\si{\degree} & -17.4\si{\degree} & 78.6\si{\degree} \\
\hline
2 & 0 & 9.16 &\si{\degree} -30.6\si{\degree} & -30.6\si{\degree} \\
\hline
3 & 2 & 3.94\si{\degree} & -150.2\si{\degree} & -29.8\si{\degree} \\
\hline
\etab
\et{Cross correlation delay results of signal from front right}{04_cc}
% -------------------------------------------------------------

\Cref{subsec:03_directionCandidates} explains how two possible direction
results exists by considering the delay between a channel pair.
In \Cref{tab:04_cc}, both arising direction candidates are listed for
all channel delays.
% and how the unification of those candidates takes place.
...
Base Channel & Next Channel & Delay & Candidate (-) & Candidate (+)\\
\hline
0 & 1 & -8.28\si{\degree} & -144.7\si{\degree} & -35.3\si{\degree}\\
\hline
1 & 3 & -4.09\si{\degree} & -22.8\si{\degree} & 84.0\si{\degree}\\
\hline
2 & 0 & 7.60\si{\degree} & -30.6\si{\degree} & -30.6\si{\degree}\\
\hline
3 & 2 & 4.13\si{\degree} & -148.7\si{\degree} & -31.3\si{\degree}\\
\hline
\etab
\et{Generalized cross correlation delay results of signal from front right. Two possible
	direction candidates exists by considering the delay between a channel pair}{04_gcc}
% -------------------------------------------------------------
...
\hline
1 & 3 & -79.1\si{\degree} & -26.8\si{\degree} & 88.0\si{\degree}\\
\hline
2 & 0 & 167.7\si{\degree} & -30.6\si{\degree} & -30.6\si{\degree}\\
\hline
3 & 2 & 88.5\si{\degree} & -148.7\si{\degree} & -31.3\si{\degree}\\
\hline
\etab
\et{Resulting candidates of phase difference method with fixed frequency
	...
	(-33.7\si{\degree})
	Two possible
	direction candidates exists by considering the delay between a channel pair
}{04_fixedFreqResult}
% -------------------------------------------------------------
...
Base Channel & Next Channel & Phase Difference & Candidate (-) & Candidate (+)\\
\hline
1 & 3 & -102.7\si{\degree} & -17.6\si{\degree} & 78.8\si{\degree}\\
\hline
2 & 0 & 173.4\si{\degree} & -30.6\si{\degree} & -30.6\si{\degree}\\
\hline
3 & 2 & 113.1\si{\degree} & -140.7\si{\degree} & -39.3\si{\degree}\\
\hline
\etab
...
\hline
\etab
\et{Method comparison of averaged \acp{RMSE} of single robot \ac{WSDE}
	results. All laboratory-measurements are considered}
