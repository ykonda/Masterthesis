...
According to \cref{subsubsec:03_phase}, the maximal feasible frequency is defined as
2775.08\si{\hertz} and the whistle spectrum ranges between 2\si{\kilo\hertz}
and 4\si{\kilo\hertz}.
\missing[]{Continue here! Say that limited by geometry?}
...
of 2600\si{\hertz}.
For the evaluation of the static reference frequency, 
