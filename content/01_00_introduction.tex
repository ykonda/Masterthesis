...
Additionally, from a robots' perspective additional information about the environment
...
\todo[inline]{Hier ein mal TDOA ausschreiben}
\todo[inline]{Du solltest ein mal SSL als Begriff/Abkuerzung einfuehren}
...
\todo[inline]{Fueg noch einen Satz ein, dass die SSL dabei hilt. (auch wenn es
offensichtlich erscheint) bevor die die anderen Anwendungsfaelle erklaerst}
...
which consists of four microphones attached on the robot's head.\todo{maybe: has four microphones attached
to its head. (der besteht ja noch aus mehr als das)}
...
\todo[inline]{Vielleicht davor: "This thesis is structured as follows:"}
...
the results of the different approaches are evaluated with real data in \cref{chap:04_evaluation}.\todo{Vielleicht: "on a real-world dataset" statt "read data"}
With the outcome of this, a final conclusion is summarized in \Cref{chap:05_conclusion}.\todo{"conclusion is summarized" klingt falsch. Vielleicht: "A final conclusion and summary is presented in"}
