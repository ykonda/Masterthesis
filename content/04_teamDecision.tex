...
\cref{subsec:04_labMeasurements}.\todo{Maybe state that this is the HULKs lab
(just to show that this is the largest field you had access to, not that you
scaled it on purpose.)}
...
the signal data from these measurements will be used mainly.\todo{I don't think
this sentence is relevant. If you want to keep it, clarify what you mean by
"these"}
% -------------------------------------------------------------
\btline{ht}{1.2}
\btab{|c|c|c|c|}
...
\todo[inline]{I would not put the Measurements in brackets}
% -------------------------------------------------------------
\btline{ht}{1.2}
\btab{|c|c|c|}
\hline
